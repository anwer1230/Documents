...
export type AiToneId = 'formal' | 'casual' | 'persuasive' | 'humorous' | 'concise' | 'poetic' | 'empathetic' | 'professional' | 'pirate' | string;
...
export interface MessageFactCheck {
  ...
  verdict?: 'verified' | 'misleading' | 'disputed' | 'unverified' | string;
  summary?: string;
  sourceUrl?: string;
  checkedAt?: string;
  [key: string]: any;
