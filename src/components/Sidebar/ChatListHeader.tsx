        ...
        {isSearchActive || searchQuery ? (
          ...
          <>
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div
                onClick={() => setIsDrawerOpen(true)}
                className="relative shrink-0 w-7 h-7 rounded-full flex items-center justify-center shadow-md cursor-pointer hover:scale-105 transition-transform"
                style={{
                  background: 'linear-gradient(180deg, #2AABEE 0%, #229ED9 100%)',
                }}
                title="Telegram (Official Build)"
              >
                <svg className="w-4 h-4 text-white -translate-x-[0.5px] relative z-10 drop-shadow" viewBox="0 0 240 240" fill="none">
                  <path
                    fill="#FFFFFF"
