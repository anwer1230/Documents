...
export const FOLDERS = [
  ...
  { id: 'personal', name: 'Personal', nameAr: 'خاص', icon: 'User', chatTypes: ['private'] },
  { id: 'channels', name: 'Channels', nameAr: 'القنوات', icon: 'Megaphone', chatTypes: ['channel'] },
  { id: 'groups', name: 'Groups', nameAr: 'المجموعات', icon: 'Users', chatTypes: ['group'] },
  { id: 'bots', name: 'Bots', nameAr: 'البوتات', icon: 'Bot', chatTypes: ['bot'] },
];
