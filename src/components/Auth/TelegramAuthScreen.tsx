  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Telegram Official Paper Airplane Logo */}
        <div
          className="relative w-20 h-20 rounded-full flex items-center justify-center shadow-xl shadow-[#229ed9]/30 mb-5 cursor-pointer hover:scale-105 active:scale-95 transition-transform"
          style={{
        ...
        >
          ...
          <div className="absolute inset-0 rounded-full bg-[#2aabee]/20 blur-md -z-10" />
          
          <svg className="w-12 h-12 text-white translate-x-[-1.5px] translate-y-[0.5px] drop-shadow" viewBox="0 0 240 240" fill="none">
            <path
              fill="#FFFFFF"
