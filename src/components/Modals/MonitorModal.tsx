...
import { DEFAULT_MONITORING_TEXT } from '../../core/defaultMonitoringPhrases';
...
export const MonitorModal: React.FC = () => {
  ...
  const [keywordsText, setKeywordsText] = useState(DEFAULT_MONITORING_TEXT);
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-5 flex-1">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              {alerts.length > 0 && (
                <button
                  onClick={() => notificationsService.clearMonitorAlerts()}
