  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-black/30 scrollbar-thin bg-[#0e1621]">
        ...
        <div className="p-4 bg-[#17212b] text-center text-xs text-gray-400 space-y-3 border-t border-white/5">
          <div className="flex flex-col items-center justify-center gap-2">
            {/* Animated Multi-Color Telegram Icon */}
            <div className="relative shrink-0 w-10 h-10 rounded-full tg-multicolor-gradient flex items-center justify-center shadow-lg shadow-sky-500/25">
              <div className="tg-multicolor-glow" />
              <svg className="w-5 h-5 text-white -translate-x-0.5 relative z-10 drop-shadow" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div>
              ...
              <div className="font-mono text-[11px] text-sky-400 font-semibold mt-0.5">
                v12.9.2.0 (2246) universal arm64-v8a
              </div>
            </div>
          </div>

          <div className="pt-2.5 border-t border-white/5 space-y-2 text-center">
            <div className="text-xs font-semibold text-[#5288c1]">
              {isArabic ? 'المطور:' : 'Developer:'} <span className="text-white font-medium">انور فواد محمد علي سيف</span>
            </div>
            <div className="text-[10px] text-gray-400 font-mono">
              Anwer Foud Mohammed Ali Saif
            </div>

            {/* Direct Contact Banner with +966510349663 */}
            <div className="inline-flex items-center justify-center gap-2 px-3 py-1.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400">
              <span className="text-[11px] text-emerald-300 font-semibold">{isArabic ? 'رقم الاتصال المباشر:' : 'Direct Phone:'}</span>
              <a
                href="tel:+966510349663"
                className="text-xs font-mono font-bold hover:underline flex items-center gap-1 text-emerald-300"
                dir="ltr"
              >
            ...
            <div className="flex items-center justify-center gap-4 text-[11px] font-mono text-gray-400 pt-1" dir="ltr">
