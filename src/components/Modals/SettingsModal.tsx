            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {settingsSubPage === 'plus_general' && (
                  <PlusGeneralView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_chats' && (
                  <PlusChatsView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_stories' && (
                  <PlusStoriesView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_messages' && (
                  <PlusMessagesView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_topics' && (
                  <PlusTopicsView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_drawer' && (
                  <PlusDrawerView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_profile' && (
                  <PlusProfileView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_notifications' && (
                  <PlusNotificationsView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_privacy' && (
                  <PlusPrivacyView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_media' && (
                  <PlusMediaView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_downloads' && (
                  <PlusDownloadsView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
                {settingsSubPage === 'plus_ads' && (
                  <PlusAdsView onBack={() => setSettingsSubPage('plus_settings')} />
                )}
