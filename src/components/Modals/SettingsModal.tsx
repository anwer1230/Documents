      ...
      <div className="flex-1 overflow-y-auto divide-y divide-black/30 scrollbar-thin bg-[#0e1621]">
        ...
        <div className="p-4 bg-[#17212b] text-center text-xs text-gray-400 space-y-3 border-t border-white/5">
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            <div
              className="relative shrink-0 w-10 h-10 rounded-full flex items-center justify-center shadow-lg shadow-sky-500/25"
              style={{
                background: 'linear-gradient(180deg, #2AABEE 0%, #229ED9 100%)',
              }}
            >
              <svg className="w-5 h-5 text-white -translate-x-[0.5px] relative z-10 drop-shadow" viewBox="0 0 240 240" fill="none">
                <path
                  fill="#FFFFFF"
