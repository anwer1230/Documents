...
export const ChatInput: React.FC = () => {
  ...
  const handleChannelJoin = async () => {
    ...
    // Execute DrKLO MessagesController.joinChannel with cloud processUpdates
    await messagesController.joinChannel(activeChat.id);
  ...
  return (
    ...
    >
      ...
      {/* Channel / Group Unjoined Blue Join Button (DrKLO Telegram UI) */}
      {ChatObject.isNotInChat(activeChat) ? (
