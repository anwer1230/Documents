...
/**
 * InAppNotificationBanner - Official Telegram Android Notification Layout
 * Supports swipe to dismiss (left / right / up) and 'X' close button.
 */
  ...
  return (
    <AnimatePresence mode="popLayout">
      ...
      >
        ...
        >
          {/* Subtle Swipe Handle Indicator */}
          <div className="w-10 h-1 bg-white/20 hover:bg-white/40 rounded-full mx-auto -mt-1 mb-2 transition-colors pointer-events-none" />
