...
export namespace TLRPC {
  ...
  export class TL_help_appUpdate {
    public _: string = 'help.appUpdate';
    public id: number = 0;
    public version: string = '';
    public text: string = '';
    public document?: any = null;
    public url?: string;
    public can_not_skip?: boolean;
    [key: string]: any;
  }

  export class TL_channels_leaveChannel {
    public _: string = 'channels.leaveChannel';
    public channel: any;
    [key: string]: any;
  }

  export class TL_messages_updatePinnedMessage {
    public _: string = 'messages.updatePinnedMessage';
    public flags: number = 0;
    public silent?: boolean;
  ...
  export class TL_messages_forwardMessages {
    public _: string = 'messages.forwardMessages';
    public flags: number = 0;
    public silent?: boolean;
  ...
  export class TL_account_sendVerifyEmailCode {
    public _: string = 'account.sendVerifyEmailCode';
    public purpose: any;
    public email: string = '';
    [key: string]: any;
  }
