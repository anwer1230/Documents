...
function legacyEnabled() {
  // The legacy UI is part of the product, not an optional development
  // service. Keep it enabled unless an operator explicitly disables it.
  return process.env.LEGACY_FLASK_ENABLED !== "false";
}
